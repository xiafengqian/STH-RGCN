...
def load_metr_la_data():
    ...
    # X = flow
    # print(X.shape)
    return A, X, X1, X2, X3, X4, X5, X6, X7, X8, means, stds, X1_train, X2_train, X3_train, X4_train, X5_train, X6_train, X7_train, X8_train, X1_val, X2_val, X3_val, X4_val, X5_val, X6_val, X7_val, X8_val
